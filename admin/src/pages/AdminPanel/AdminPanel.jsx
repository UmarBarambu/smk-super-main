      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative group">
          ...
          <ul className="absolute right-0 mt-2 w-40 bg-white shadow-md rounded-md border hidden group-hover:block">
            <li className="p-2 hover:bg-gray-100 cursor-pointer">{t("profile")}</li>
            <li className="p-2 hover:bg-gray-100 cursor-pointer">{t("settings")}</li>
            <li
...
//       <img src={logo} alt="logo" width={50} />
//       <div className="flex items-center gap-6">
//         <span className="text-gray-700 text-lg font-medium">{t("welcome")}</span>
...
//               <h2 className="text-2xl font-semibold mb-4">{t("allBookings")}</h2>
//               <div className="mb-4 flex items-center gap-2">
//                 <label htmlFor="roomTypeFilter" className="font-medium text-gray-700">
//                   {t("filterByRoom")}
//                 </label>
//               </div>
//               <table className="w-full text-sm border">
...
//                           </div>
//                         )}
//                         <button className="text-red-600 hover:text-red-800 text-lg p-1">
//                           <FaTrash /> {t("delete")}
//                         </button>
//                       </td>
//                     </tr>
...
//                   className="border px-2 py-1 rounded"
//                 >
//                   <option value="library">{t("type")}: Library</option>
//                   <option value="meeting">{t("type")}: Meeting</option>
//                   <option value="special">{t("type")}: Special</option>
//                 </select>
//                 <input
//                   type="number"
//                   placeholder={t("capacity")}
